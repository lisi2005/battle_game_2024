...
new_tank::new_tank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void new_tank::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void new_tank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool new_tank::IsHit(glm::vec2 position) const {
...
const char *new_tank::UnitName() const {
  return "New Tank";
}

const char *new_tank::Author() const {
  return "Li Si";
}
}  // namespace battle_game::unit
