//mytank
#include "lisi_tank.h"
#include "battle_game/core/bullets/star.h"
...
lisi_tank::lisi_tank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void lisi_tank::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void lisi_tank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool lisi_tank::IsHit(glm::vec2 position) const {
...
const char *lisi_tank::UnitName() const {
  return "Lisi Tank";
}

const char *lisi_tank::Author() const {
  return "Li Si";
}
}  // namespace battle_game::unit
